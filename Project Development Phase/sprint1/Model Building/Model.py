...
model.add(Conv2D(1024, (3, 3), padding='same', input_shape=(32, 32, 3), activation='relu'))
model.add(MaxPool2D(pool_size=(2, 2)))
model.add(Dropout(0.2))
...
history = model.fit(train_batches, batch_size=32,validation_data=test_batches,epochs=10)
